...
<main>
    <div class="wit-vlak">
        <div class="content">
            ...
            <div class="invul">
                <div class="form--group">
                    <label for="naam">Vul hier het bedrag in:</label>
        ...
        <div class="buttons">
            <a href="stappenplan_5-uitgaven.php" class="btn-primary">Terug</a>
            <a href="stappenplan_7-advies.php" class="btn-primary">Volgende</a>
        </div>
        ...
        <div class="total-progress">
            <div class="progress">
                <div class="progress-bar" id="6-overige-uitgaven" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="max-width: 100%;">
